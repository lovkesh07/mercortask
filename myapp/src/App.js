...
import TextAnimation from "./components/Textpart";
import Scrollpart from "./components/Scrool";

function App() {
  return (
    <div className=" font-customised1 bg-black ">
      <div className=" ml-8 mt-8 fixed top-0 left-0 text-white w-11 h-11 rounded-full m-5 bg-[#101010] flex items-center justify-center z-50 ">
        <svg
        className="bg-[#202020] p-2 rounded-[50%] shadow-lg shadow-white-200  "
          width="40"
          height="40"
          viewBox="0 0 450 450"
          fill="#fff"
      ...
      <div className=" w-32 fixed top-0 right-0 m-5 z-50 mr-8 mt-8 ">
        <button className=" w-[100%] px-1 py-2 bg-white rounded-xl font-bold text-lg">
          Join Beta
        </button>
      </div>
